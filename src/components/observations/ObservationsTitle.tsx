    ...
    <>
      <div className="mr-6 flex gap-4 w-[72%] justify-between">
        ...
        <div className="w-[18%]">
          ...
          <div className="flex items-center border-b border-blue-600 focus:border-blue-600">
            <select
              id="underline_select"
              className="block py-2.5 px-0 w-full  bg-transparent border-0  appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 peer">
              <option selected>Dan Chanivet</option>
              <option value="US">Dan</option>
        ...
        <div className="w-[18%]">
          ...
          <div className="flex pt-2 pb-3 border-0 border-b border-blue-600">
      ...
      <div className="flex flex-wrap items-start items-center justify-end gap-8 pt-4 -mb-3">
        <span>
          {" "}
          <img
        ...
        <button
          ...
          className={`${viewType == 1 ? "bg-sky-200" : "bg-white"
            } p-2 rounded`}>
          <img
            style={{ width: "15px", height: "15px" }}
            src={`${viewType == 1 ? "/icons/viewHover1.png" : "/icons/view1.png"
              }`}
            alt="ASIO Earth"
          />
        </button>
        <button
          ...
          className={`${viewType == 2 ? "bg-sky-200" : "bg-white"
            } p-2 rounded`}>
          <img
            style={{ width: "15px", height: "15px" }}
            src={`${viewType == 2 ? "/icons/viewHover2.png" : "/icons/view2.png"
              }`}
            alt="ASIO Earth"
          />
        </button>
        <button
          ...
          className={`${viewType == 3 ? "bg-sky-200" : "bg-white"
            } p-2 rounded`}>
          <img
            style={{ width: "15px", height: "15px" }}
            src={`${viewType == 3 ? "/icons/viewHover3.png" : "/icons/view3.png"
              }`}
            alt="ASIO Earth"
          />
        </button>
